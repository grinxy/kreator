export function HowItWorksSection() {
  return (
    <section id="como-funciona" className="py-16 md:py-24 bg-kreator-gray-light">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            <div className="w-16 h-16 bg-kreator-yellow text-white rounded-full flex items-center justify-center text-2xl font-bold mb-6 mx-auto">
              1
            </div>
            <h3 className="text-xl font-bold text-kreator-blue mb-4 text-center">Bloquea tu sector</h3>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-bold text-kreator-blue mb-4 text-center">Conéctate con tu equipo</h3>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-bold text-kreator-blue mb-4 text-center">Cobra comisiones</h3>
