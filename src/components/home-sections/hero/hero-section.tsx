  ...
  return (
    <SectionWrapper id="inicio" className="relative bg-kreator-blue text-white py-12 md:py-33">
      <div className="text-center">
        ...
        <h3 className="text-lg md:text-xl mb-8 text-gray-200 max-w-3xl mx-auto">
      ...
      {/* Animated little arrow */}
      <Link
        href="#sobre-kreator"
        className="absolute bottom-5 md:bottom-16 left-1/2 -translate-x-1/2 text-kreator-yellow cursor-pointer animate-bounce"
      >
