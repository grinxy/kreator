...
export function TestimonialsSection() {
  const testimonials = [
    ...
    },
    {
      ...
      content:
        "La plataforma es intuitiva y las conexiones que he hecho son de alta calidad. Definitivamente recomiendo Kreator.",
      initials: "AR",
    },
    {
      name: "Luis García",
  ...
  return (
    <section id="testimonios" className="py-16 md:py-24 bg-muted" aria-labelledby="testimonials-heading">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <Card
              key={index}
              className="hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border-border"
            >
              <CardContent className="p-6">
                ...
                <div className="flex items-center">
                  <Avatar className="mr-3">
                    <AvatarFallback className="bg-kreator-blue/10 text-kreator-blue font-semibold">
