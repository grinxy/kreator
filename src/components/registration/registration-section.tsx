      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-0">
          ...
          <div className="space-y-6 text-center lg:text-left">
            <h1
              id="registro-title"
              className="text-3xl lg:text-5xl font-bold text-[var(--kreator-blue)] font-[family-name:var(--font-poppins)]"
            >
            ...
            <p className="text-lg text-[var(--kreator-gray-dark)] font-[family-name:var(--font-opensans)] leading-relaxed max-w-lg mx-auto lg:mx-0">
              ...
              que quieren vender más, generar contactos de calidad y crecer en red.
            </p>
            ...
            <p className="text-base text-[var(--kreator-gray-dark)] font-[family-name:var(--font-opensans)] leading-relaxed max-w-lg mx-auto lg:mx-0">
              ...
              <strong className="text-[var(--kreator-gray-dark)]">
                un profesional por sector
              </strong>
              , lo que te garantiza visibilidad y elimina la competencia interna. Una misma zona puede tener{" "}
              <strong className="text-[var(--kreator-gray-dark)]">
                varios equipos
              </strong>
              , según el volumen de negocio disponible.
            </p>
